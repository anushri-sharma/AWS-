...
# [Amazon FSx](https://skillbuilder.aws/renderer/?module_id=18SQAPSR8X%3A001.000.000&product_id=8D79F3AVR7%3A002.002.003&registration_id=3a5edca9-7621-5cd1-8fb0-7734f046051b&referrer=https%3A%2F%2Fskillbuilder.aws%2Flearn%2F94T2BEN85A%2Faws-cloud-practitioner-essentials%2F8D79F3AVR7&navigation=digital)

## AnyCompany Media wants to migrate its file shares to AWS while maintaining compatibility with existing applications. They need a solution that supports Server Message Block (SMB) protocol and integrates with Microsoft Active Directory.

Which AWS service should they implement in this scenario?

> **Amazon FSx for Windows File Server** is a fully managed Windows file system. It supports SMB protocol, integrates with Active Directory, and provides the Windows compatibility needed for this scenario.
---

# Additional Storage Solutions

# [AWS Storage Gateway](https://skillbuilder.aws/renderer/?module_id=18SQAPSR8X%3A001.000.000&product_id=8D79F3AVR7%3A002.002.003&registration_id=3a5edca9-7621-5cd1-8fb0-7734f046051b&referrer=https%3A%2F%2Fskillbuilder.aws%2Flearn%2F94T2BEN85A%2Faws-cloud-practitioner-essentials%2F8D79F3AVR7&navigation=digital)

## AnyCompany has a large collection of files stored on-premises that needs to be backed up to the AWS Cloud. They want to maintain local access to frequently used files while using cloud storage for cost savings. They also want to minimize changes to their existing file-sharing workflows and applications.

Which AWS Storage Gateway type BEST addresses these requirements?

> Amazon S3 File Gateway
> S3 File Gateway provides a file interface into Amazon S3 so the team can store and retrieve objects using standard file protocols like NFS and SMB. With S3 File Gateway, frequently accessed data is cached locally for low-latency access while data is stored in Amazon S3 for durability and cost-effectiveness.

---
## AnyCompany Manufacturing stores CAD files that need to be accessed frequently by engineers at their on-premises data center. They want to maintain local access to this data while also benefiting from AWS Cloud storage capabilities. They plan to implement a solution that provides low-latency access to frequently used files while backing up data to AWS.

Which AWS Storage Gateway configuration should they choose?
> 
Implement Storage Gateway in Cached Volume mode to keep frequently accessed data local while storing the complete dataset in Amazon S3.
> Cached Volume mode is ideal for this scenario because it stores the most frequently accessed data locally for low-latency access while maintaining the complete dataset in Amazon S3. This provides both the local performance that engineers need and the benefits of secure cloud backup.
---

# [AWS Elastic Disaster Recovery](https://skillbuilder.aws/renderer/?module_id=18SQAPSR8X%3A001.000.000&product_id=8D79F3AVR7%3A002.002.003&registration_id=3a5edca9-7621-5cd1-8fb0-7734f046051b&referrer=https%3A%2F%2Fskillbuilder.aws%2Flearn%2F94T2BEN85A%2Faws-cloud-practitioner-essentials%2F8D79F3AVR7&navigation=digital)

## AnyCompany Telecommunications is concerned about potential downtime after experiencing an outage last quarter. They want to implement a disaster recovery solution for their on-premises server fleet but have limited IT staff. The CEO is particularly concerned about maintaining exact replicas of production servers and minimizing recovery time.
...
---
# [Comparing Storage Services](https://skillbuilder.aws/renderer/?module_id=18SQAPSR8X%3A001.000.000&product_id=8D79F3AVR7%3A002.002.003&registration_id=3a5edca9-7621-5cd1-8fb0-7734f046051b&referrer=https%3A%2F%2Fskillbuilder.aws%2Flearn%2F94T2BEN85A%2Faws-cloud-practitioner-essentials%2F8D79F3AVR7&navigation=digital)
